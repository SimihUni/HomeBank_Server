...
try {
  privateJWK = JSON.parse(readFileSync('./keys/private.key.json').toString()) as jose.JWK
  console.log(privateJWK)
  publicJWK = JSON.parse(readFileSync('./keys/public.key.json').toString()) as jose.JWK
